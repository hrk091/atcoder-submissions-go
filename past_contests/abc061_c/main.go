...
func main() {
	...
	q := newPQueue(func(highP, lowP record) bool {
		return highP.val < lowP.val
	})
...
type pQueue struct {
	data    []record
	compare func(highP, lowP record) bool
}

func newPQueue(fn func(highP, lowP record) bool) *pQueue {
	return &pQueue{
		data:    []record{},
		compare: fn,
	}
